...
void FOnPickUp_DelegateWrapper(const FMulticastScriptDelegate& OnPickUp, ACryptRaiderCharacter* PickUpCharacter)
{
	...
	struct Z_CompiledInDeferFile_FID_Users_Paolo_Documents_Projects_Unreal_CryptRaider_CryptRaider_Source_CryptRaider_TP_PickUpComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Paolo_Documents_Projects_Unreal_CryptRaider_CryptRaider_Source_CryptRaider_TP_PickUpComponent_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Paolo_Documents_Projects_Unreal_CryptRaider_CryptRaider_Source_CryptRaider_TP_PickUpComponent_h_2770244957(TEXT("/Script/CryptRaider"),
		Z_CompiledInDeferFile_FID_Users_Paolo_Documents_Projects_Unreal_CryptRaider_CryptRaider_Source_CryptRaider_TP_PickUpComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Paolo_Documents_Projects_Unreal_CryptRaider_CryptRaider_Source_CryptRaider_TP_PickUpComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
